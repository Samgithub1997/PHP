...
$('#submit1').click(function(){
	...
	$.ajax({
		...
		success:function(data){
			if(data.name=="error")
			{
				$('#matter').html("Invalid credentials");
			}
			else
			{
...
<div class="col-sm-6 ">
	<h1 class="marh m2"><center> IEEE SBM </center> </h1>
			...
			&nbsp &nbsp	<a  id="blog" class="lin" style="background-color:#99bbff; border-radius:8px; padding-top:8px ;padding-bottom:8px; padding-right:10px;padding-left:10px;text-decoration-color:#001a33;"><span class="glyphicon glyphicon-zoom-in"></span>Our Blog</a></center></h4>
</div>
